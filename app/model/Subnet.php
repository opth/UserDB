...
class Subnet extends Table {
    ...
    public const ERR_NO_GW = 2;
    public const ERR_MULTIPLE_GW = 3;

    public const ARP_PROXY_SUBNET = "89.248.240.0/20";
    public const ARP_PROXY_GW = "89.248.255.254";

    public const ARP_PROXY_DESCRIPTION = "Při zapnuté ARP Proxy se veřejné IP adrese z daného subnetu automaticky nastaví subnet 89.248.240/20 s bránou 89.248.255.254";
